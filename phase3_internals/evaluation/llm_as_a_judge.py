...
# ── Configurazione ─────────────────────────────────────────────────────────────
load_dotenv(dotenv_path="/Users/tommasomilanino/Developer/THESIS/key.env")
        ...
        for attempt in range(8):
            try:
                ...
                if not raw_output:
                    ...
                    print(f"[VUOTO] finish={response.choices[0].finish_reason} "
                          f"completion_tokens={response.usage.completion_tokens} "
                          f"reasoning_tokens={response.usage.completion_tokens_details} "
